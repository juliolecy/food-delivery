        ...
        <Layout>
            <div className={css.container}>
                <div className={css.imageWrapper}>
                    <Image loader={() => src} alt='' layout='fill' unoptimized objectFit='cover' src={src} />
                </div>
                ...
                <div className={css.right}>
                    ...
                    <div className={css.quantity}>
                        ...
                        <div className={css.counter}>
                            <Image onClick={()=>handleQuan('dec')} src={LeftArrow} height={20} width={20} alt='' objectFit='contain' />
                            <span>{Quantity}</span>
                            <Image onClick={()=>handleQuan('inc')} src={RightArrow} height={20} width={20} alt='' objectFit='contain' />
                        </div>
                    </div>
